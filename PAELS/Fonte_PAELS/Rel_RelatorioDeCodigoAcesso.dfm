object Form_Rel_RelacaoComCodigo: TForm_Rel_RelacaoComCodigo
  Left = 539
  Top = 145
  Width = 837
  Height = 854
  Caption = 'PAELS --> Rela'#231#227'o Contendo C'#243'digo de Acesso dos Instrutores'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRSubDetail_Comentario: TQRSubDetail
      Left = 19
      Top = 120
      Width = 756
      Height = 72
      ...
      AlignToBottom = False
      BeforePrint = QRSubDetail_ComentarioBeforePrint
      Color = clWhite
      ...
      object QRLabel_Codigo: TQRLabel
        Left = 108
        Top = 45
        Width = 381
        Height = 20
    ...
    object QRBand2: TQRBand
      ...
      object QRLabel_Cabec: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'RELA'#199#195'O DE INSTRUTORES COM C'#211'DIGO'
        Color = clWhite
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
  ...
  object IBQuery_AlunoTurma: TIBQuery
    ...
    CachedUpdates = False
    SQL.Strings = (
      'Select  NomeCompleto, NomeGuerra, CodigoAluno as Codigo'
    ...
    object IBQuery_AlunoTurmaNOMECOMPLETO: TIBStringField
      ...
      Origin = 'ALUNOS_TURMA_VIEW.NOMECOMPLETO'
      Size = 125
    end
    object IBQuery_AlunoTurmaCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'ALUNOS_TURMA_VIEW.CODIGOALUNO'
    end
    object IBQuery_AlunoTurmaNOMEGUERRA: TIBStringField
      FieldName = 'NOMEGUERRA'
      Origin = 'ALUNOS_TURMA_VIEW.NOMEGUERRA'
    end
  end
end
