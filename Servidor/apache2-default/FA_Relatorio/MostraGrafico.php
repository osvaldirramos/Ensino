...
<?php
   ...
   echo "
             ...
             <img style='cursor: pointer;' onclick='minDiv($row_Res_sql_nomeTop[DESCRICAO]);' src='min.gif' width='16' height='14' border='0'></td><td><img style='cursor: pointer;' onclick='maxDiv($row_Res_sql_nomeTop[DESCRICAO]);' src='max.png' width='16' height='14' border='0'></td>
             </tr>
                 <tr>
