...
<br><br>
<div align="center">
<form name="form1" method="POST" action="ListaDeAvaliacoes_p.php" target="_self">
<?php
   echo "<div>";
   echo "<p class= 'style3'>Escolha do Curso/Turma.</p><br>";
   ...
   echo "<img src='image/line.png' width='30' height='30' border='0'>";
   echo "</br>";
   ...
   while ($dado_Curso=ibase_fetch_assoc($ResCurso))
   {
      ...
      $sql_Turma = "Select Distinct a.IdTurma, t.Turma, t.Ano
                    ...
                    Order By a.idcurso, a.idturma desc";
