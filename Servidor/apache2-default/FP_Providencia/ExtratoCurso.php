...
<div id="corpo">
<div id="barra" align="left"><a href='ListaFichasExtrato.php' target='_self' > << Mudar Curso</a></div>
<div id="conteudo">
<form name="form1" method="POST" action="registrarSessaoExtrato.php">
<?php
   $sql="Select codcurso
         From curso
   ...
   $sql= "Select fa.IdFicha,fa.IDENTIDADE,  fa.STATUS,
          ...
          and ( fa.idturma=$_SESSION[idTurma1] or fa.idturma=$_SESSION[idTurma2] or fa.idturma=$_SESSION[idTurma3])
