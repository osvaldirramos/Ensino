 ...
 <NOSCRIPT>
    ...
    você deve habilitar o javascript no seu navegador ou atualizar sua versão de navegador a uma mais recente.
		...
		<div class="w3-card w3-margin w3-margin-top w3-padding w3-blue">
		  ...
		  <p><h4><p>Bem-Vindo ao Portal de Indicação do PTS<h4></p></p>
		</header>
	  ...
	  <div class="w3-card w3-margin w3-margin-top w3-center w3-padding w3-blue">
		...
		<form id="form1" name="form1" method="POST" action="Logar.php" onSubmit="return submete();">
            ...
            <div class="form-group col-md-6 text-left">
                              <p class="w3-text-white">Selecione o Curso *</p>
                           <select name="curso" id="curso" class="form-control w3-center" required>

                           <?php 
                               $sql= "Select distinct c.idcurso,c.codcurso
                               ...
                               $Res_sql_curso=ibase_query($conexao,$sql);
                               while($curso=ibase_fetch_assoc($Res_sql_curso))
                               {
                                   //echo " <option>$relacionado[[CODCURSO]</option> ";
