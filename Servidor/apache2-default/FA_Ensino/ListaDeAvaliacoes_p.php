...
/*  while ($dados01=ibase_fetch_assoc($ResSql01))
  {
     ...
     $cor= setCor($dados01[STATUS]);
     echo "<option value= $var02 style='background:$cor'>- $Var01-  $dados01[IDENTIDADE]</option>";
  }
*/
   //---
  ...
  while ($dados02=ibase_fetch_assoc($ResSql02))
  {
    ...
    $cor= setCor($dados02[STATUS]);
     echo "<option value= $var03 style='background:$cor'>- $Var01</option>";
     echo "<option value= $var04 style='background:$cor'>- $Var02</option>";
   }
...
/*
   while ($dados03=ibase_fetch_assoc($ResSql03))
   {
     ...
     $cor= setCor($dados03[STATUS]);
      echo "<option value= $var04 style='background:$cor'>- $Var01</option>";
   }
   ...
   while ($dados04=ibase_fetch_assoc($ResSql04))
   {
     ...
     $cor= setCor($dados04[STATUS]);
      echo "<option value= $var05 style='background:$cor'>- $Var01</option>";
   }
*/
   echo "</select>";
