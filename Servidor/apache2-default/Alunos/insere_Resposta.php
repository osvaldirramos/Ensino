...
<?php
  ...
  //--------------------------------------------------------------------------------------------
   ...
   $Res_Comando = ibase_query($conexao, $Comando);
     ...
     //------------------------------------------------------------------------------------------
    //  Tratamento para inserir Tecnica quando for Formulario anexo H (13)

       $Comando= " Delete From FAC_TECNICA
                   where IDAVALIACAO = $_SESSION[IdAvaliacao]
                   and   IDAVALIADOR = '$_SESSION[identidadeAluno]'
                   and   IDFICHA = $_SESSION[idFicha]";
       $Res_Comando= ibase_query($conexao, $Comando);     
       ...
       if($_POST[tecnica] != "") {
           $Comando= "insert into FAC_TECNICA (IDAVALIACAO, IDAVALIADOR, IDFICHA, TECNICA )
                      values  ($_SESSION[IdAvaliacao],'$_SESSION[identidadeAluno]',$_SESSION[idFicha], '$_POST[tecnica]' )";
