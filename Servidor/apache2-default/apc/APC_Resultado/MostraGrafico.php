...
?>
  ...
  <hr size='1'/>
  <div id="titulo" class="style4">SUBDIRETORIA DE ENSINO</div>
  <div id="titulo" class="style4">DIVISÃO DE AVALIAÇÃO</div>
  <hr size='1'/>
  <div id="corpo">
...
<?php //----
   ...
   GravaGrafico($conexao, $Indice, $VI_Pessimo, 'Nenhuma', $VI_Ruim, 'Pouca', $VI_Regular, 'Média', $VI_Bom, 'Muita', $VI_Otima, 'Total',$VI_Excelente,'Excelente');
