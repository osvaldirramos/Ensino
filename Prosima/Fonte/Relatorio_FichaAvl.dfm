object Form_Relatorio_FichaAvl: TForm_Relatorio_FichaAvl
  ...
  Caption = 'Ensino --> Relat'#243'rio do Cadastro de Alunos com C'#243'digo'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand_Cabecalho: TQRBand
      ...
      AlignToBottom = False
      BeforePrint = QRBand_CabecalhoBeforePrint
      Color = clWhite
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
      Font.Height = -13
  ...
  object IBTable_CadFichaAvl: TIBTable
    ...
    MasterFields = 
      'IDCURSO;IDTURMA;ID_FICHA;ID_ATCO;ID_AVL;ID_EXERCICIO;ID_INSTRUTO' +
      'R'
    MasterSource = Form_Sel_Rel_FichaAvaliacao.DSQ_Cad_FichaAvl
    StoreDefs = True
  ...
  object IBQuery_PR_Avaliacao: TIBQuery
    Database = DM.IBDatabase_Prosima
    Transaction = DM.IBTransaction_Prosima
    BufferChunks = 1000
    CachedUpdates = False
    ...
    SQL.Strings = (
      ...
      'and      ID_EXERCICIO = :ID_EXERCICIO'
        ...
        'Order By IDCURSO, IDTURMA, ID_ATCO, ID_FICHA, ID_ITEM, Id_AVL, I' +
        'D_EXERCICIO')
    Left = 393
    Top = 336
    ParamData = <
    ...
    object IBQuery_PR_AvaliacaoAREA_AVALIACAO: TIBStringField
      FieldName = 'AREA_AVALIACAO'
      Origin = 'AVALIACAO.AREA_AVALIACAO'
      Size = 50
    end
    object IBQuery_PR_AvaliacaoBOM: TIBStringField
      FieldName = 'BOM'
      Origin = 'AVALIACAO.BOM'
      FixedChar = True
      Size = 1
    end
    object IBQuery_PR_AvaliacaoDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Origin = 'AVALIACAO.DESCRICAO'
      Size = 60
    end
    object IBQuery_PR_AvaliacaoID_ATCO: TIBStringField
      FieldName = 'ID_ATCO'
      Origin = 'AVALIACAO.ID_ATCO'
      Required = True
      FixedChar = True
    end
    object IBQuery_PR_AvaliacaoID_AVL: TIBStringField
      FieldName = 'ID_AVL'
      Origin = 'AVALIACAO.ID_AVL'
      Required = True
      FixedChar = True
    end
    object IBQuery_PR_AvaliacaoID_EXERCICIO: TIntegerField
      FieldName = 'ID_EXERCICIO'
      Origin = 'AVALIACAO.ID_EXERCICIO'
      Required = True
    end
    object IBQuery_PR_AvaliacaoID_FICHA: TIntegerField
      FieldName = 'ID_FICHA'
      Origin = 'AVALIACAO.ID_FICHA'
      Required = True
    end
    object IBQuery_PR_AvaliacaoID_ITEM: TIBStringField
      FieldName = 'ID_ITEM'
    ...
    object IBQuery_PR_AvaliacaoIDCURSO: TSmallintField
      FieldName = 'IDCURSO'
      Origin = 'AVALIACAO.IDCURSO'
      Required = True
    end
    object IBQuery_PR_AvaliacaoIDTURMA: TIntegerField
      FieldName = 'IDTURMA'
      Origin = 'AVALIACAO.IDTURMA'
      Required = True
    end
    object IBQuery_PR_AvaliacaoNA: TIBStringField
      FieldName = 'NA'
      Origin = 'AVALIACAO.NA'
      FixedChar = True
      Size = 1
    end
    object IBQuery_PR_AvaliacaoNS: TIBStringField
      FieldName = 'NS'
      Origin = 'AVALIACAO.NS'
      FixedChar = True
      Size = 1
    end
    object IBQuery_PR_AvaliacaoOTIMO: TIBStringField
      FieldName = 'OTIMO'
      Origin = 'AVALIACAO.OTIMO'
      FixedChar = True
      Size = 1
    end
    object IBQuery_PR_AvaliacaoREGULAR: TIBStringField
      FieldName = 'REGULAR'
  ...
  object DSQ_PR_Avaliacao: TDataSource
    DataSet = IBQuery_PR_Avaliacao
    Left = 433
    Top = 334
  end
