...
uses Module, ImageWin, frmSimbolo;
...
begin
   ...
   ToolButton_Simbolo.Enabled:= Status;
...
//------------------------------------------------------------------------------
// Tratamento da janel a de simobolos
//------------------------------------------------------------------------------

procedure TForm_Cad_Diploma.ToolButton_SimboloClick(Sender: TObject);
var
  VS_Font: String;
  VI_Size: Integer;
begin
