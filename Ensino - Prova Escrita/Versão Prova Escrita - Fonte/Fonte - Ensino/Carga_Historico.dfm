object Form_Carga_Historico_: TForm_Carga_Historico_
  Left = 555
  Top = 324
  AutoScroll = False
  Caption = 'Ensino --> Carga para Historico'
  ClientHeight = 683
  ClientWidth = 1441
  Color = 16577515
  Ctl3D = False
  ...
  object JvCaptionPanel4: TJvCaptionPanel
    ...
    object ToolBar_SelecaoAluno: TToolBar
      ...
      ParentColor = False
      TabOrder = 1
      object JvEdit_NomeAluno: TJvEdit
        Left = 0
        Top = 2
        Width = 262
        Height = 24
        Hint = 'Realiza filtro pelo Nome de Guerra do aluno.'
        Alignment = taCenter
        BevelInner = bvSpace
        BevelKind = bkFlat
        GroupIndex = -1
  ...
  object JvCaptionPanel2: TJvCaptionPanel
    ...
    Buttons = []
    BorderStyle = bsNone
    Caption = ' Ensino -> Informa'#231#245'es da Turma'
    CaptionPosition = dpTop
    CaptionFont.Charset = ANSI_CHARSET
    CaptionFont.Color = clWhite
    CaptionFont.Height = -13
    ...
    object JvShape_Ativar: TJvShape
      Left = 9
      Top = 34
      Width = 103
      Height = 44
    ...
    object JvTransparentButton_Ativar: TJvTransparentButton
      Left = 10
      Top = 36
      Width = 101
      Height = 42
      Hint = 'Passa a Turma que esta com o Status de Encerrada para Ativo'
      BorderWidth = 0
      ...
      ShowHint = True
      TextAlign = ttaBottom
      OnClick = JvTransparentButton_AtivarClick
    end
  ...
  object IBQuery_MontaTurma: TIBQuery
    ...
    object IBQuery_MontaTurmaDATAINICIODIST: TDateTimeField
      FieldName = 'DATAINICIODIST'
      Origin = 'TURMA.DATAINICIODIST'
    end
    object IBQuery_MontaTurmaDATATERMINODIST: TDateTimeField
      FieldName = 'DATATERMINODIST'
      Origin = 'TURMA.DATATERMINODIST'
    end
    object IBQuery_MontaTurmaRADIO: TIBStringField
      FieldName = 'RADIO'
      Origin = 'TURMA.RADIO'
      Size = 30
    end
    ...
    object IBQuery_MontaTurmaDURACAO: TIntegerField
      FieldName = 'DURACAO'
      Origin = 'TURMA.DURACAO'
    end
    ...
    object IBQuery_MontaTurmaMODALIDADE: TIBStringField
      FieldName = 'MODALIDADE'
      Origin = 'TURMA.MODALIDADE'
      Size = 10
    end
    object IBQuery_MontaTurmaCOD: TIntegerField
      FieldName = 'COD'
      Origin = 'TURMA.COD'
    end
    object IBQuery_MontaTurmaCERTIFICADO: TIntegerField
      FieldName = 'CERTIFICADO'
      Origin = 'TURMA.CERTIFICADO'
    end
    object IBQuery_MontaTurmaLOCAL1: TIBStringField
      FieldName = 'LOCAL1'
      Origin = 'TURMA.LOCAL1'
    end
    object IBQuery_MontaTurmaQTDBRASILEIROS: TIntegerField
      FieldName = 'QTDBRASILEIROS'
      Origin = 'TURMA.QTDBRASILEIROS'
    end
    object IBQuery_MontaTurmaQTDESTRANGEIROS: TIntegerField
      FieldName = 'QTDESTRANGEIROS'
      Origin = 'TURMA.QTDESTRANGEIROS'
    end
    ...
    object IBQuery_MontaTurmaPARTICIPA_ESTATISTICA: TIBStringField
      FieldName = 'PARTICIPA_ESTATISTICA'
      Origin = 'TURMA.PARTICIPA_ESTATISTICA'
      FixedChar = True
      Size = 1
    end
    object IBQuery_MontaTurmaLOCAL2: TIBStringField
      FieldName = 'LOCAL2'
      Origin = 'TURMA.LOCAL2'
    end
    object IBQuery_MontaTurmaADMINISTRATIVAS: TIntegerField
      FieldName = 'ADMINISTRATIVAS'
      Origin = 'TURMA.ADMINISTRATIVAS'
    end
    object IBQuery_MontaTurmaINSTRUCAO: TIntegerField
      FieldName = 'INSTRUCAO'
      Origin = 'TURMA.INSTRUCAO'
    end
    object IBQuery_MontaTurmaFLEXIBILIZACAO: TIntegerField
      FieldName = 'FLEXIBILIZACAO'
      Origin = 'TURMA.FLEXIBILIZACAO'
    end
    object IBQuery_MontaTurmaAVALIACAO: TIntegerField
      FieldName = 'AVALIACAO'
      Origin = 'TURMA.AVALIACAO'
    end
  end
  ...
  object IBTable_H_Curso: TIBTable
    Database = DM_Historico_SGEW.IBDatabase_Historico_SGEW
    Transaction = DM_Historico_SGEW.IBTransaction_Historico_SGEW
    ...
    Left = 449
    Top = 87
    object IBTable_H_CursoIDCURSO: TSmallintField
      FieldName = 'IDCURSO'
    end
    object IBTable_H_CursoCODCURSO: TIBStringField
      FieldName = 'CODCURSO'
      Size = 10
    end
    object IBTable_H_CursoNOMECURSO: TIBStringField
      FieldName = 'NOMECURSO'
      Size = 300
    end
    object IBTable_H_CursoDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Size = 255
    end
    object IBTable_H_CursoTOTALEXAMESTEORICOS: TSmallintField
      FieldName = 'TOTALEXAMESTEORICOS'
    end
    object IBTable_H_CursoTOTALEXAMESPRATICOS: TSmallintField
      FieldName = 'TOTALEXAMESPRATICOS'
    end
    object IBTable_H_CursoNUMEROSEMANAAULAS: TSmallintField
      FieldName = 'NUMEROSEMANAAULAS'
    end
    object IBTable_H_CursoPAET: TIBStringField
      FieldName = 'PAET'
      Size = 1
    end
    object IBTable_H_CursoCOPM: TIBStringField
      FieldName = 'COPM'
      Size = 1
    end
    object IBTable_H_CursoNAOIMPRIMIRDIPLOMA: TIBStringField
      FieldName = 'NAOIMPRIMIRDIPLOMA'
      Size = 1
    end
  end
  object DataSource1: TDataSource
    DataSet = IBTable_H_Curso
    Left = 479
    Top = 87
  end
  object IBTable_H_Turma: TIBTable
    Database = DM_Historico_SGEW.IBDatabase_Historico_SGEW
    Transaction = DM_Historico_SGEW.IBTransaction_Historico_SGEW
    AutoCalcFields = False
    BufferChunks = 1000
    ...
    Left = 449
    Top = 119
    object IBTable_H_TurmaIDCURSO: TSmallintField
      FieldName = 'IDCURSO'
    end
    object IBTable_H_TurmaIDTURMA: TIntegerField
      FieldName = 'IDTURMA'
    end
    object IBTable_H_TurmaTURMA: TIBStringField
      FieldName = 'TURMA'
      Size = 15
    end
    object IBTable_H_TurmaANO: TIBStringField
      FieldName = 'ANO'
      Size = 4
    end
    object IBTable_H_TurmaDATAINICIO: TDateTimeField
      FieldName = 'DATAINICIO'
    end
    object IBTable_H_TurmaDATATERMINO: TDateTimeField
      FieldName = 'DATATERMINO'
    end
    object IBTable_H_TurmaDATAINICIODIST: TDateTimeField
      FieldName = 'DATAINICIODIST'
    end
    object IBTable_H_TurmaDATATERMINODIST: TDateTimeField
      FieldName = 'DATATERMINODIST'
    end
    object IBTable_H_TurmaRADIO: TIBStringField
      FieldName = 'RADIO'
      Size = 30
    end
    object IBTable_H_TurmaCOORDENADOR: TIBStringField
      FieldName = 'COORDENADOR'
      Size = 40
    end
    object IBTable_H_TurmaDURACAO: TIntegerField
      FieldName = 'DURACAO'
    end
    object IBTable_H_TurmaSTATUS: TIBStringField
      FieldName = 'STATUS'
      Size = 1
    end
    object IBTable_H_TurmaMODALIDADE: TIBStringField
      FieldName = 'MODALIDADE'
      Size = 10
    end
    object IBTable_H_TurmaCOD: TIntegerField
      FieldName = 'COD'
    end
    object IBTable_H_TurmaCERTIFICADO: TIntegerField
      FieldName = 'CERTIFICADO'
    end
    object IBTable_H_TurmaQTDBRASILEIROS: TIntegerField
      FieldName = 'QTDBRASILEIROS'
    end
    object IBTable_H_TurmaQTDESTRANGEIROS: TIntegerField
      FieldName = 'QTDESTRANGEIROS'
    end
    object IBTable_H_TurmaDESCRICAO: TIBStringField
      FieldName = 'DESCRICAO'
      Size = 300
    end
    object IBTable_H_TurmaPARTICIPA_ESTATISTICA: TIBStringField
      FieldName = 'PARTICIPA_ESTATISTICA'
      Size = 1
    end
    object IBTable_H_TurmaLOCAL2: TIBStringField
      FieldName = 'LOCAL2'
    end
    object IBTable_H_TurmaADMINISTRATIVAS: TIntegerField
      FieldName = 'ADMINISTRATIVAS'
    end
    object IBTable_H_TurmaINSTRUCAO: TIntegerField
      FieldName = 'INSTRUCAO'
    end
    object IBTable_H_TurmaFLEXIBILIZACAO: TIntegerField
      FieldName = 'FLEXIBILIZACAO'
    end
    object IBTable_H_TurmaAVALIACAO: TIntegerField
      FieldName = 'AVALIACAO'
    end
    object IBTable_H_TurmaLOCAL1: TIBStringField
      FieldName = 'LOCAL1'
    end
  end
  object DataSource2: TDataSource
    DataSet = IBTable_H_Turma
    Left = 479
    Top = 119
  end
end
