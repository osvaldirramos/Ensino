...
begin
   ...
   if DM.IBTable_Turma.FieldByName('Status').AsString = 'P' then
      QRLabel_Status.Caption:= 'Planejada'
   else
      if DM.IBTable_Turma.FieldByName('Status').AsString = 'A' then
         QRLabel_Status.Caption:= 'Em Andamento'
      else
         if DM.IBTable_Turma.FieldByName('Status').AsString = 'E' then
            QRLabel_Status.Caption:= 'Executada'
         else
            if DM.IBTable_Turma.FieldByName('Status').AsString = 'C' then
               QRLabel_Status.Caption:= 'Cancelada'
end;
