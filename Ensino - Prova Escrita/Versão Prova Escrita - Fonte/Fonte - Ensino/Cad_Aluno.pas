...
procedure TForm_Cad_Aluno.FechaTabelas;
var
   Sender: TObject;
begin
   //--- Atualiza Turma
...
begin
   if ((IBTable_AlunoTurma.State = DSInsert) or (IBTable_AlunoTurma.State = DSEdit )) then
   begin
      if ((DBComboBox_TipoLista.Text = 'CIVIL') or (DBComboBox_TipoLista.Text = 'ESTRANGEIRO'))  then
      begin
...
begin
   ...
   While not DM.IBQuery_Executa.Eof do
   begin
      if DM.IBQuery_Executa.FieldByName('Tipo_Aluno').AsString = 'ESTRANGEIRO' then
