...
begin
   ...
   if ((DM.IBTable_Configuracao.FieldByName('SIGLA').AsString = 'CINDACTA II') or (DM.IBTable_Configuracao.FieldByName('SIGLA').AsString = 'CINIPA')) then
      ...
      if ((Form_SelTurma.IBTable_AlunoTurma.FieldByName('Tipo_Aluno').AsString = 'MILITAR DA AERONÁUTICA') or
          (Form_SelTurma.IBTable_AlunoTurma.FieldByName('Tipo_Aluno').AsString = 'MILITAR DO EXÉRCITO') or
          (Form_SelTurma.IBTable_AlunoTurma.FieldByName('Tipo_Aluno').AsString = 'MILITAR DA MARINHA')) then
