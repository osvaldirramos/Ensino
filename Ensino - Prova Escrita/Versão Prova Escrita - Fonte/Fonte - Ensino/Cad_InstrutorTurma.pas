...
begin
   ...
   Funcoes_SUE.AlimentaDBComboBox(DBComboBox_Funcao, 'Funcao', 'Instrutor_Funcao', '', 'Funcao');
...
var
   VS_Identidade, VS_Data_Chegada, VS_Data_Saida, VS_POstoGraduacao, VS_Quadro: String;
begin
