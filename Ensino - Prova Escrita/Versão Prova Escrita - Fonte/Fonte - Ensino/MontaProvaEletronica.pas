...
begin
   ...
   StaticText_Msg.Caption:= 'Aguarde excluíndo Gabarito...';
   show;
   update;
   ...
   VS_Comando:=  'Select Identidade From Aluno_Turmas_View '+
                ' where IdCurso = '+Form_Cad_Prova.IBQuery_MontaTeste.FieldByName('IdCurso').AsString+
                ' and   IdTurma = '+Form_Cad_Prova.IBQuery_MontaTeste.FieldByName('IdTurma').AsString+
   ...
   begin
      VI_Gabarito:= VI_Gabarito + 1;
      StaticText_Msg.Caption:= 'Aguarde Montando Resposta Aluno Gabrito '+IntToStr(VI_Gabarito)+'...';
      ProgressBar1.StepBy(1);
      Update;
   ...
   StaticText_Msg.Caption:= 'Finalizada a montagem da Prova Eletrônica ..';
   except
      //
   end;
end;
