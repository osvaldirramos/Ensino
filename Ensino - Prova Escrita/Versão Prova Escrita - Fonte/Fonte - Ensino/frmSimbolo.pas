...
uses Module, Editor_Texto, Cad_Documentacao, Cad_Diploma;
...
begin
   Funcoes.CabecalhoForm( Form_Simbolo, ' Seleção de Simbolos');

   ComboBox_FontChange(Sender);

   case Funcoes.GetEditor of
     1: Begin
           JvxRichEdit_00.SelAttributes.Style:= Form_Editor.text1.SelAttributes.Style;
           JvxRichEdit_00.SelAttributes.Name:= Form_Editor.text1.SelAttributes.Name;
           JvxRichEdit_00.SelAttributes.Size:= Form_Editor.text1.SelAttributes.Size;
           VS_Font:= Form_Editor.Text1.Font.Name;
        end;
     3: Begin
           Application.CreateForm(TForm_Cad_Documento, Form_Cad_Documento);
           JvxRichEdit_00.SelAttributes.Style:= Form_Cad_Documento.Text1.SelAttributes.Style;
           JvxRichEdit_00.SelAttributes.Name:= Form_Cad_Documento.Text1.SelAttributes.Name;
           JvxRichEdit_00.SelAttributes.Size:= Form_Cad_Documento.Text1.SelAttributes.Size;
           VS_Font:= Form_Cad_Documento.Text1.Name;
        end;

     4: Begin
           JvxRichEdit_00.SelAttributes.Style:= Form_Cad_Diploma.Text1.SelAttributes.Style;
           JvxRichEdit_00.SelAttributes.Name:= Form_Cad_Diploma.Text1.SelAttributes.Name;
           JvxRichEdit_00.SelAttributes.Size:= Form_Cad_Diploma.Text1.SelAttributes.Size;
           VS_Font:= Form_Cad_Diploma.Text1.Name;
        end;
   end;
...
procedure TForm_Simbolo.FormClose(Sender: TObject;  var Action: TCloseAction);
begin
   Action:= caFree;
end;
...
begin
   ...
   case Funcoes.GetEditor of
     1: Form_Editor.Text1.PasteFromClipboard;
     3: Begin
          Application.CreateForm(TForm_Cad_Documento, Form_Cad_Documento);
          Form_Cad_Documento.Text1.PasteFromClipboard;
        end;
     4: Form_Cad_Diploma.Text1.PasteFromClipboard;
   end;
end;
...
begin
   case Funcoes.GetEditor of
     1: Form_Editor.Text1.Font.Name := VS_Font;
     3: Begin
           Application.CreateForm(TForm_Cad_Documento, Form_Cad_Documento);
           Form_Cad_Documento.Text1.Font.Name := VS_Font;
        end;
     4: Form_Cad_Diploma.Text1.Font.Name := VS_Font;
   end;
   Close;
end;
