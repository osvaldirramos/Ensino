...
begin
   ...
   begin
      ...
      begin
         VS_Serie:= Funcoes.VerificaSerie(Query_Item.FieldByName('IdCurso').AsString, Query_Item.FieldByName('IdTurma').AsString, MaskEdit_DiscAtual.Text, Query_Item.FieldByName('Objetivo').AsString);
