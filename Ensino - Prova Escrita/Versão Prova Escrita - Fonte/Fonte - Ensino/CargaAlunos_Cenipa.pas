...
type
  ...
  private    { Private declarations }
     ...
     VS_turma_chefe, VS_id_turma_usuario, VS_turma_usuario_cpf: String;
     VS_portal_turma_inicio, VS_portal_turma_fim, VS_turma_usuario_status: String;
     VS_portal_turma_usuario_funcao, VS_portal_turma_chefe: String;
      ...
      //begin
         ...
         begin
            ...
            begin
               VI_Cont:= VI_Cont + 1;
               case VI_Cont of
                  1:VS_id_curso:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  ...
                  16: VS_id_turma_usuario:= '';
                  17: VS_id_turma:= '';
                  18: VS_turma_usuario_cpf:= '';
                  19: VS_portal_turma_inicio:= '';
                  20: VS_portal_turma_fim:= '';
                  21: VS_turma_usuario_status:= '';
                  22: VS_portal_turma_usuario_funcao:= '';
                  23: VS_portal_turma_chefe:= '';
                  24:VS_id_usuario:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  25:VS_usuario_nome:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  26:VS_usuario_guerra:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  27:VS_usuario_posto:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  28:VS_usuario_quadro:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  29:VS_usuario_especialidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  30:VS_usuario_sexo:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  31:VS_usuario_cpf:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  32:VS_usuario_saram:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  33:VS_usuario_identidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  34:VS_usuario_org_exp:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  35:VS_usuario_data_exp:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  36:VS_usuario_naturalidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  37:VS_usuario_nacionalidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  38:VS_usuario_endereco:= UpperCase(Funcoes.DePara(VS_String, '"', ''));
                  39:VS_usuario_bairro:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  40:VS_usuario_cidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  41:VS_usuario_estado:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  42:VS_usuario_cracha_validade:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  43:VS_usuario_cep:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  44: VS_usuario_nascimento:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  45: VS_usuario_praca:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  46: VS_usuario_promocao:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  47: VS_usuario_classe:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  48: VS_usuario_nivel:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  49: VS_usuario_unidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  50: VS_usuario_subunidade:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  51: VS_usuario_celular:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  52: VS_usuario_residencial:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  53: VS_usuario_ramal:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  54: VS_usuario_email:= Funcoes.DePara(VS_String, '"', '');
                  55: VS_usuario_inicio:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  56: VS_usuario_termino:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  57: VS_usuario_senha:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  58: VS_usuario_pai:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  59: VS_usuario_mae:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  60: VS_usuario_cnh:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  61: VS_id_turma:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  62: VS_usuario_hash:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  63: VS_usuario_status:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  64: VS_usuario_funcao:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  65: VS_usuario_militar:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  66: VS_usuario_civil:= Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  67: VS_usuario_modelo:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  68: VS_usuario_marca:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  69: VS_usuario_cor:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  70: VS_usuario_placa:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  71: VS_usuario_fabricacao:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  72: VS_usuario_renavam:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  73: VS_usuario_foto:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  74: VS_usuario_cadastro:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  75: VS_usuario_conteudo_ministrado:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  76: VS_usuario_ip_confirma:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  77: VS_usuario_chefe:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  78: VS_usuario_chefe_email:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
                  79: VS_usuario_chefe_telefone:= '';   // Funcoes.AjustarMaiscula(Funcoes.DePara(VS_String, '"', ''));
         ...
         if ((VS_usuario_cpf = '') and (VS_usuario_identidade = '')) then
            ShowMessage('Vazio')
         else
         begin
            ...
            begin
               ...
               begin
                  if ((VS_usuario_funcao = 'ALUNO') and (Form_SelTurma.VS_Opcao = 'Carregar Aluno')) then
                  begin
                     Tratar_Aluno_ICEA(VI_ContReg)
                  end
                  else
                     if ((VS_usuario_funcao <> 'ALUNO') and (Form_SelTurma.VS_Opcao = 'Carregar Instrutor')) then
                     begin
...
begin
   ...
   begin
      ...
      IBTable_InstrutorTurma.FieldByName('Funcao').AsString:= VS_usuario_funcao;
