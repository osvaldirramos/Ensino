unit Rel_ControleDeRefeicoes;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ExtCtrls, QuickRpt, QRCtrls, jpeg, DB, IBCustomDataSet, IBQuery, Rotinas, Rotinas_TrataData;

type
  TForm_Rel_ControleDeRefeicoes = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRShape5: TQRShape;
    QRShape7: TQRShape;
...
var
  Form_Rel_ControleDeRefeicoes: TForm_Rel_ControleDeRefeicoes;
...
procedure TForm_Rel_ControleDeRefeicoes.QRBand1BeforePrint(Sender: TQRCustomBand; var PrintBand: Boolean);
begin
   IBQuery_AlunoTurma.Open;
   QRLabel_NomeAluno.Caption:= Trim(IBQuery_AlunoTurma.FieldByName('PostoGraduacao').AsString)+' '+
                               IBQuery_AlunoTurma.FieldByName('Nome').AsString;
end;

procedure TForm_Rel_ControleDeRefeicoes.QuickRep1BeforePrint(Sender: TCustomQuickRep; var PrintReport: Boolean);
var
...
procedure TForm_Rel_ControleDeRefeicoes.FormClose(Sender: TObject; var Action: TCloseAction);
begin
