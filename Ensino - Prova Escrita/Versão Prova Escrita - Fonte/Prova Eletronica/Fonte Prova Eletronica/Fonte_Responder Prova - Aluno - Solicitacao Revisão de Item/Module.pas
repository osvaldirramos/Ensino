...
begin
   ...
   begin
      ...
      begin
         MessageDlg('O arquivo "Servidor.cnf" não foi encontrado na pasta "C:\DataBase_ICEA\Ensino" '+#13+
                    'Este arquivo contém o endereço do Banco de Dados'+#13+#13+
                    'Favor entrar em contato com o responsável',mtError, [mbOk],0);
...
begin
    ...
    Try
       ...
       IBDatabase_Ensino.Connected:= False;
       MessageDlg('Servidor fora do ar, tente novamente ou entre em contato com o Fiscal',mtError, [mbOk],0);
       Application.terminate;
    end;
...
procedure TDM.Timer_DisponibilidadeMaquinaTimer(Sender: TObject);
begin
   Funcoes.Verifica_Disponibilidade_Rede;
   Funcoes.Verifica_Disponibilidade_BD;
end;
