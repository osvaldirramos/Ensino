    ...
    <div class="w3-main w3-padding">        
        ...
        <?php 
                ...
                if ($Comando[QTD] == 0) {
                   ...
                   $sql_Comando="Select s.IdPTS, s.IdSemana, s.Dia_Semana, s.Trab_escolar, s.id
                                 From  pts_semana s
                                 Where s.IdPTS = $IdPTS
...
//   echo "$sql_Comando";
                   ...
                   $sql= "Select PE.idpts, PE.idsemana, PE.idinstrutor, PE.postograduacao, PE.nomeguerra, PE.unidade, PE.status, PE.ID
