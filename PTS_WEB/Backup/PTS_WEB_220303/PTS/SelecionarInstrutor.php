       ...
       <div class="w3-main w3-padding">        
           ...
           <?php 
               ...
               while($relacionado=ibase_fetch_assoc($Res_sql_Instrutor))
               {
                   ...
                   echo "  <td class='td_cabec_Center'><a class='w3-btn w3-green w3-ripple w3-text-white' href='IndicarInstrutor.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$IdPTS."&op4=".$IdSemana."&op5=".$relacionado[IDINSTRUTOR]."&op6= 1' role='button' type='submit' formmethod='post'>Indicar</a></td>";
                   echo "</tr>";
               }
