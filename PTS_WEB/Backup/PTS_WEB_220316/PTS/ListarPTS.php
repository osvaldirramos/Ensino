        ...
        <div class="w3-main w3-padding">        
            ...
            <?php 
                ...
                if ($Comando[QTD] == 0) {
                   ...
                   $sql= "Select p.IdCurso, p.IdTurma, p.IdPTS, s.IdSemana, s.Dia_Semana, s.Horario, s.Trab_escolar
                          From pts_principal P, pts_semana s
                          Where p.IdPTS = s.IdPTS
                          and   p.IdCurso = $IdCurso
                          and   p.IdTurma = $IdTurma";
//   echo "---$sql";
                   ...
                   while($relacionado=ibase_fetch_assoc($Res_sql_relacionado))
                   {
                      ...
                      echo "   <td  name Horario style='display:none'>" . $relacionado[HORARIO] . "</td>";
//                      echo "   <td class='td_cabec_Center' name DiaSemana>" . $relacionado[DIA_SEMANA] . "</td>";
                      echo "   <td class='td_cabec_Center' name Trab_Escolar>" . $relacionado[TRAB_ESCOLAR] . "</td>";
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-blue w3-ripple w3-text-white' href='InstrutorIndicado.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."&op5=".$relacionado[DIA_SEMANA]."&op6=".$relacionado[HORARIO]."' role='button' type='submit' formmethod='post'>Indicar Instrutor</a></td>";
