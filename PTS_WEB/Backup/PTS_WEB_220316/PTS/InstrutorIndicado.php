...
//   echo "$sql_Comando";
                   ...
                   echo "  <td class='td_cabec_Center'><a class='w3-btn w3-blue w3-ripple w3-text-white' href='SelecionarInstrutor.php?op1=".$IdCurso."&op2=".$IdTurma ."&op3=". $IdPTS."&op4=".$IdSemana ."&op5=".$DiaSemana ."&op6=".$Horario."' role='button' type='submit' formmethod='post'>Selecionar Instrutor</a></td>";
...
//                          and   PS.DiaSemana= '$DiaSemana'
//                          and   PS.Horario= '$Horario'";
                   $PTS= 3;
   echo "$sql";
