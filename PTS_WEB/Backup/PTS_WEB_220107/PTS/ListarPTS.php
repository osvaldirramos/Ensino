  ...
  <body>
        ...
        <div class="w3-main w3-padding">        
            ...
            <?php 
                ...
                if ($Comando[QTD] == 100) {
                   ...
                   $sql= "Select p.IdCurso, p.IdTurma, p.IdPTS, p.Semana, s.IdSemana, s.Dia_Semana, s.Trab_escolar
                          From pts_principal P, pts_semana s
                          Where p.IdPTS = s.IdPTS
                          and   p.IdCurso = $IdCurso
                          and   p.IdTurma = $IdTurma";
   echo "$sql";
                   ...
                   while($relacionado=ibase_fetch_assoc($Res_sql_relacionado))
                   {
                      ...
                      echo "   <td  name IdCurso style='display:none'>" . $relacionado[IDPTS] . "</td>";
                      echo "   <td  name IdTurma style='display:none'>" . $relacionado[IDSEMANA] . "</td>";
                      echo "   <td class='td_cabec_Center' name Curso>" . $relacionado[DIA_SEMANA] . "</td>";
                      echo "   <td class='td_cabec_Center' name Curso>" . $relacionado[TRAB_ESCOLAR] . "</td>";
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-blue w3-ripple w3-text-white' href='InstrutorIndicado.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."' role='button' type='submit' formmethod='post'>Indicar Instrutor</a></td>";
