       ...
       <div class="w3-main w3-padding">        
           <div class="w3-center">
              <ul class="nav nav-pills nav-fill">
                  <?php 
                      echo "    <li class='w3-large w3-text-black'><b/>RELAÇÂO DE INSTRUTORES DO $idLocalidade $Localidade</b></li>";
                      echo "    <li class='w3-large'>&nbsp</li>";
                      echo "    <li class='w3-large'>&nbsp</li>";
                      echo "    <li class='w3-large'>&nbsp</li>";
                      echo "    <li class='w3-medium'><a class='w3-btn w3-blue w3-ripple' href='InstrutorIndicado.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$IdPTS."&op4=".$IdSemana."'>Voltar</a></li>";
                  ?>
               </ul> 
           </div>
           ...
           <?php 
               ...
               echo "<thead class='w3-2019-galaxy-blue'>";
                  echo "<tr> ";
                      ...
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-blue w3-ripple w3-text-white' href='CadastrarInstrutor.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$IdPTS."&op4=".$IdSemana."' role='button' type='submit' formmethod='post'>Cadastrar Instrutor</a></td>";
                  echo "</tr>";
               echo "</thead>";
               ...
               while($relacionado=ibase_fetch_assoc($Res_sql_Instrutor))
               {
                   ...
                   echo "  <td class='td_cabec_Center'><a class='w3-btn w3-green w3-ripple w3-text-white' href='TratarStatus.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."&op5=".$relacionado[IDINSTRUTOR]."&op6= 1' role='button' type='submit' formmethod='post'>Indicar-</a></td>";
                   echo "</tr>";
               }
