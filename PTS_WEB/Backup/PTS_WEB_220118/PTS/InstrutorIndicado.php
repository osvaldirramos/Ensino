...
//   echo "$sql_Comando";
                   ...
                   echo "<ul class='nav nav-pills nav-fill'>";
                   echo "    <li class='w3-large w3-text-black'><b/>INSTRUTORES INDICADOS PARA O CURSO: $Query_Curso[CODCURSO] TURMA: $Query_Curso[TURMA]<br> 
                                                                    NA DISCIPLINA: $Query_Disciplina[TRAB_ESCOLAR]	</b></li>";
                   ...
                   $sql= "Select PE.idpts, PE.idsemana, PE.idinstrutor, PE.postograduacao, PE.nomeguerra, PE.unidade, PE.status
...
//                      echo "   <td  name Id_instrutor style='display:none'>" . $relacionado[ID_INSTRUTOR] . "</td>";
                      ...
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-green w3-ripple w3-text-white' href='TratarStatus.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."&op5=".$relacionado[IDINSTRUTOR]."&op6= 1' role='button' type='submit' formmethod='post'>Selecionado</a></td>";
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-blue w3-ripple w3-text-white' href='TratarStatus.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."&op5=".$relacionado[IDINSTRUTOR]."&op6= 2' role='button' type='submit' formmethod='post'>Indicado</a></td>";
                      echo "  <td class='td_cabec_Center'><a class='w3-btn w3-red w3-ripple w3-text-white'   href='SelecionarInstrutor.php?op1=".$IdCurso."&op2=".$IdTurma."&op3=".$relacionado[IDPTS]."&op4=".$relacionado[IDSEMANA]."' role='button' type='submit' formmethod='post'>Excluir</a></td>";
                      echo "</tr>";
