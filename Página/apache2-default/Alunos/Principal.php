    	...
    	<div class="conteudo">
          ...
          <?php
             ...
             $sql_Comando="Select count(1) as Qtd
                           ...
                           and   FR.IdAvaliador = '$Identidade'
                           and   FO.dataavaliacao <= '$DataAtual'
                           and   FR.respondeu = 'N'
                           and   (FO.IdFicha <> 4 and FO.IdFicha <> 14)";
...
//echo " $sql_Comando";
        ...
        <div class="conteudo">
           ...
           <table border='0' width='1000'>
              <tr>
                  <td width='12' align='center'>INSTITUTO DE CONTROLE DO ESPAï¿½O Aï¿½REO</br>
                                                SEï¿½ï¿½O DE EXECUï¿½ï¿½O DE CURSOS
                  </center>
              </td>
              </tr>
           </table>
