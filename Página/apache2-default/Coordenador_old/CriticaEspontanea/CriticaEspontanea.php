...
<?php
   ...
   echo "<table border='0' cellspacing='0' cellpadding='0' width='770' class='style3' >
            <tr>";
             // <td><img src='../image/icea.PNG' border='0'></td>
   echo   "       <td> <td width='770' align='Center'><p style='font-size:13px' align='center'><b>FORMULÁRIO DE CRÍTICA ESPONTÂNEA</b></p></td> ";
