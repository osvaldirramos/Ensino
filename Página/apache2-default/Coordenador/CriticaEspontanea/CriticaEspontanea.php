...
<?php
   ...
   echo "<table border='0' cellspacing='0' cellpadding='0' width='1000' class='style3' >
            <tr>";
             // <td><img src='../image/icea.PNG' border='0'></td>
   echo   "       <td> <td width='1000' align='Center'><p style='font-size:13px' align='center'><b>FORMULÁRIO DE CRÍTICA ESPONTÂNEA</b></p></td> ";
           //   <td><img src='../image/trainair.PNG' border='0'></td></td>
    echo   "</tr>
         </table>";
   echo "</br>";

   echo "<div align='right'><a href='RelacaoCriticasEspontanea.php' title='Retorna para página anterior' target='nucleo' >
            <img src='../../imagem/sair.png' border='0' width='25' height='25' > Retornar
            <br> </a>
         </div> <br>";
...
<?php
   ...
   echo "<table border='0' cellspacing='0' cellpadding='0' width='1000' >
            <tr>
