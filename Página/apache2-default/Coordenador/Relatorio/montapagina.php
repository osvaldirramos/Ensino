...
<?php
   ...
   echo "<div id='titulo' class='BODY'>INSTITUTO DE CONTROLE DO ESPAÇO AÉREO</div>";
   echo "<p align='center'>DIVISÃO DE ENSINO</p>";
   echo "<p align='center'>SUBDIVISÃO DE AVALIAÇÃO</p>";
   echo "<br/>";
   if ($idModelo != "00")
   {
...
<?php
   ...
   echo "<br><br>";
   echo " 1-Péssimo    2-Ruim     3-Regular     4-Bom      5-Ótimo      6-Excelente";
   echo "<br><br>";
