...
//   echo "$sql_Comando";
                   ...
                   $sql= "Select distinct PE.idpts, PE.idsemana, PE.Dia_Semana, PE.idinstrutor, PE.trab_escolar, PE.postograduacao, PE.nomeguerra, PE.unidade, PE.status, PE.ID
                          From PTS_Indicacao PE, pts_semana PS
                          where PE.idpts = PS.idpts
                          and PE.idsemana = PS.idsemana
                          and PE.Dia_Semana = PS.Dia_Semana
                          and PE.Trab_Escolar = PS.Trab_Escolar
                          and   PS.IdPTS = $IdPTS
                          and   PE.IdSemana = $IdSemana
                          and   PS.Dia_Semana = '$DiaSemana'
