...
<br>
 ...
 <table border="0" width="100%" >
    <tr>
       <td width="192" align="center"><a href="../Alunos_FAC/index.php" title="Ferramenta de Auxílio as Atividades do Coordenador" >
         <img src="../imagem/coordenador.png" border="0" width="50" height="50" ><br> <div id="descricao"> Coordenador</div></a>
       </td>
       
       <td width="192" align="center"><a href="../Alunos_FAC/index.php" title="Fichas de avaliação de Cursos - Aluno" >
         <img src="../imagem/alunos.png" border="0" width="50" height="50" ><br> <div id="descricao">Aluno</div></a>
       </td>
       
       <td width="192" align="center"><a href="../Alunos_FAC/index.php" title="Fichas de avaliação de Cursos - Instrutor" >
         <img src="../imagem/instrutor.png" border="0" width="50" height="50" ><br> <div id="descricao">Instrutor</div></a>
       </td>
       
       <td width="192" align="center"><a href="../Alunos_FAC/index.php" title="Fichas de avaliação de Cursos - ICEA" >
