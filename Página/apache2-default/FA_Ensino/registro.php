<?php
   ...
   /*
Select u.IdCodigo, u.nome, u.senha from usuario u, perfilacesso p where (u.nome = 'GERMANO' and Senha = 'CXN345') and (u.idCodigo = p.idcodigo and Modulo = 'Extras - Consulta de Ficha de Avaliação de Curso' and p.possuiacesso = 'S' )
   */
