<?php 
   ...
   else
   {
      $sqlcomplemento = "insert into APC_COMPLEMENTO (IDCURSO,IDTURMA,CODMATERIA,IDCODIGO,IDENTIFICACAO,ATUANAFUNCAO,DIFICULDADES,CONSIDERACOES)
                                VALUES ('$_SESSION[idCurso]','$_SESSION[idTurma]','$row[CODMATERIA]','$_SESSION[idCodigo]','$_SESSION[identificacao]','$_REQUEST[atuando]','$_REQUEST[dificuldade]','$_REQUEST[sugestao]')";
