...
function upper(){
  var login;
  var senha;
  login  = document.form1.login.value.toUpperCase();
  document.form1.login.value = login;

  senha = document.form1.senha.value.toUpperCase();
  document.form1.senha.value = senha;
}
...
<BR>
<div id="titulo" class="BODY">Resultado da Avaliação Pós-Curso</div>
<BR>
<p>&nbsp;</p>
