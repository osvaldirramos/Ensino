...
//        $_SESSION[codDisciplina] = substr($_SESSION[dadosFicha],2,6);//COLETA DADO A SER ENVIADO PRA INSERÇÃO
        ...
        while($Respondidos=ibase_fetch_assoc($Res_respondidos))
        {
         ...
         echo "<hr size='1'/>";
         echo "<tr>
                  <td width='820'style='font-size:10px'>Curso: <b style='font-size:10px'>$curso[CODCURSO] (<b style='font-size:10px'>$curso[NOMECURSO]</b>)</td>
               </tr>";
...
<?
           ...
           echo "<table cellspacing='0' cellpadding='0' border '1' width='100%'>
                  ...
                  <tr>
                   <div><td>&nbsp; <img src='MontaGraficoBarraExtrato.php?sessao=$Indice&tipo=$tipo&legenda=$legenda&nome=Img$_SESSION[dadosFicha]' ></td>";
           echo  "</tr>
                  </div>
                 </table>";
...
?>
 ...
 <?php
          ...
          $sql_Complemento = "select c.idCurso,
                                     c.IdTurma,
                                     c.Disciplina,
          ...
          {
             $Sql_Turma= "Select Turma, Ano From Turma Where IdCurso = $row[IDCURSO] and IdTurma = $row[IDTURMA]";
             $Res_Turma=ibase_query($conexao,$sSql_Turma);
             $Turma=ibase_fetch_assoc($Res_Turma);
             if($row[COMENTARIO])
             {
                if ($idModelo == "00")     //--- Monta o comentario com relação ao Extrato
                {
                   if ($row[DISCIPLINA] != "000000")    // mostra a disciplina e o instrutor no extrato
                   {
                      echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                              <tr>
                                 <td width = '450' class = 'style3'>&nbsp;$VI_Cont - $Turma[TURMA]/$Turma[ANO] - $row[DISCIPLINA] - $row[DESCDISCIPLINA]<br/><br/>
                   ...
                   else
                   {
                      echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                              <tr>
                                 <td width = '450' class = 'style3'>&nbsp;$VI_Cont - $Turma[TURMA]/$Turma[ANO] - $row[COMENTARIO] <br/><br/>
                              </tr>
                            </table>";
                   }
                }
        ...
        if ($idModelo == "00")     //--- Monta o comentario com relação ao Extrato
        {
            $sql_CriticaAluno = "select IdCurso, IdTurma, Disciplina, IdInstrutor, comentario
            ...
            while ($dado_Critica =  ibase_fetch_assoc($ResCriticaAluno))
            {
               ...
               $Sql_Turma= "Select Turma, Ano From Turma Where IdCurso = $_SESSION[idCurso] and IdTurma = $dado_Critica[IDTURMA]";
               $Res_Turma=ibase_query($conexao,$Sql_Turma);
               $Turma=ibase_fetch_assoc($Res_Turma);
               ...
               if($dado_Critica[COMENTARIO])
               {
                  ...
                  echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                          <tr>
                            <td width = '450' class = 'style3'>&nbsp;$VI_Cont - Turma: $Turma[TURMA]/$Turma[ANO] <br/> 
         ...
         if ($idModelo == "00")      //--- Monta o comentario com relação ao Extrato
         {
            ...
            $sql_Complemento = "select IdCurso, IdTurma, Disciplina, descdisciplina, comentario
            ...
            while ($row =  ibase_fetch_assoc($ResComplemento))
            {
               $Sql_Turma= "Select Turma, Ano From Turma Where IdCurso = $_SESSION[idCurso] and IdTurma = $row[IDTURMA]";
               $Res_Turma=ibase_query($conexao,$Sql_Turma);
               $Turma=ibase_fetch_assoc($Res_Turma);
               ...
               if($row[COMENTARIO])
               {
                  echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                          <tr>
                             <td width = '450' class = 'style3'>&nbsp;$VI_Cont - Turma: $Turma[TURMA]/$Turma[ANO] <br/> $row[DISCIPLINA] - $row[DESCDISCIPLINA] <br><br>
                                                                          $row[COMENTARIO] <br/><br/>
                          </tr>
                        </table>";
                  $VI_Cont++;
         ...
         if ($idModelo == "00")     //--- Monta o comentario com relação ao Extrato
         {
            ...
            while ($dado_Critica =  ibase_fetch_assoc($ResCriticaAluno))
            {
               ...
               if($dado_Critica[COMENTARIO])
               {
                  ...
                  echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                          <tr>
                            <td width = '450' class = 'style3'>&nbsp;$VI_Cont Turma: $Turma[TURMA]/$Turma[ANO] <br/> $Disciplina $Docente<br/>
                                                                     $Retorno <br/>
                                </tr>
                              </table>";
               }
            ...
            $sql_Complemento = "select IdCurso, IdTurma, Disciplina, descdisciplina, Identidade, comentario
                                From FA_Comentario_View
                                 where IDCURSO= $_SESSION[idCurso]
                                 and ( idturma=$_SESSION[idTurma1] or idturma=$_SESSION[idTurma2] or idturma=$_SESSION[idTurma3])
                                 and (IdFicha = 2)";
            ...
            while ($row =  ibase_fetch_assoc($ResComplemento))
            {
               ...
               if($row[COMENTARIO])
               {
                  if ($row[DISCIPLINA] != "000000")
                  {
                     echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                             <tr>
                                <td width = '450' class = 'style3'>&nbsp;$VI_Cont - Turma: $Turma[TURMA]/$Turma[ANO] <br/> 
                                                                         Coordenado: $dado_Pessoa[POSTOGRADUACAO] $dado_Pessoa[NOMEGUERRA] <br>
                  ...
                  else
                  {
                     echo "<table cellspacing='0' cellpadding='0' border '1' width='770'>
                             <tr>
                                <td width = '450' class = 'style3'>&nbsp;$VI_Cont - $Turma[TURMA]/$Turma[ANO] <br/> 
                                                                         Coordenador: $dado_Pessoa[POSTOGRADUACAO] $dado_Pessoa[NOMEGUERRA] <br>
                                                                         $row[COMENTARIO] <br/><br/>
                                  </tr>
                         </table>";
                  }
             ...
             //---
            //--- Tratamento do comentario de Critica do Aluno

            if ($idModelo == "00")     //--- Monta o comentario com relação ao Extrato
            {
               $sql_CriticaAluno = "select  IdCurso, IdTurma, Disciplina, IdInstrutor, IdCriticador, comentario
                                      From FA_CriticaEspontanea
                                      where IDCURSO= $_SESSION[idCurso]
                                      and ( idturma=$_SESSION[idTurma1] or idturma=$_SESSION[idTurma2] or idturma=$_SESSION[idTurma3])
