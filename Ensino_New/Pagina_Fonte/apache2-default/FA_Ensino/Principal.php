...
<div align="center" id="topo"><img src="../imagem/topo.png"></div>
 <BR>
<div align='center'>Versão 1.01</div>
<BR>
<p>&nbsp;</p>
   <div align="center">
...
<?php
   ...
   echo "<table border-color='#FE6161' border='1' cellspacing='0' cellpadding='0' width='770' class='style3'>
         <tr bgcolor='#CCCCCC'>
   ...
   echo"<table border='1' cellspacing='0' cellpadding='0' width='770' class='style3'>
       <tr>
         <td align='center'><span style='font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 12px;'>[Qde de Turmas - $num_turmas]   [Qde de Alunos - $num_alunos]</span></td>
       </tr>
       </table>"."<br>";
