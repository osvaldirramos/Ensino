  ...
  <body onLoad="AlternarAbas('td_providencia','div_providencia')">
   ...
   <tr>
    ...
    <div id="div_providencia" class="conteudo" style="display:none">
     ...
     <br>
<?php
      echo"<div><table id='rodape'><tr><td width='500'>Curso:<strong> $_SESSION[nomeCurso] - $_SESSION[codCurso]</strong>  </td><td>Período:<strong> $_SESSION[inicio]</strong> à <strong>$_SESSION[termino]</strong></td></tr></table></div>";
