...
<?php
   ...
   else
   {
      ...
      $Sql_Turma= "Select IDTURMA, TURMA, Ano, Descricao From Turma where IdCurso = 139 ";
      $VS_Opcao= " and ";
      ...
      $Sql_Turma.= " and Status <> 'P' ) Order By DataInicio desc";
      ...
      while($relacionado=ibase_fetch_assoc($Res_sql_relacionado))
      {
         echo "<option value= '$relacionado[IDTURMA]'>  - $relacionado[TURMA] - $relacionado[ANO] - $relacionado[DESCRICAO]  </option>";
      }
      echo "</select>";
      echo "<BR>";
      echo "<BR>";
