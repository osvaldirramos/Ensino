...
<?php
   ...
   {
      echo "<table border='0' cellspacing='0' cellpadding='0' width='770' bgcolor='#cccccc' bordercolor='#FFFFFF' >
               <tr> ";
   ?>
         ...
         echo "<table style:border-bottom:1px solid #ccc; border='0' cellspacing='0' cellpadding='0' width='770' class='caixa'>
                  <tr>
                     ...
                     <tr border='1'>
                        ...
                        <td width='60'><span style='font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #5D5D5D;'>Não avaliado </span></td>
