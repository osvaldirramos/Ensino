...
<?php
   ...
   <?php        echo "</tr>
      ...
      echo "</div>";
      echo "<p> Utilize este campo para nos dar a sua opinião sobre o tópico '$Topicos[DESCRICAO]':</p>
            <p>
             <label>
              <textarea class='caixa' name='comentario$Topicos[IDTOPICO]' id='comentarios' maxlength='490' cols='85' rows='2' onKeyDown='valida_longitude()' onKeyUp='valida_longitude()'></textarea>
             </label><br><br><br>";
    }
   ...
   <p>
    <label>
      <textarea name='comentario' id='comentarios' cols='60' rows='4' onKeyDown='valida_longitude()' onKeyUp='valida_longitude()'></textarea>
