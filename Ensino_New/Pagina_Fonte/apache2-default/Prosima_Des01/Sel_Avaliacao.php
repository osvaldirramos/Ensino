...
<table border="0" width="100%" >
  <tr>
   ...
   <font color="#000080"><h3>NOVA<br>FICHA</h3></font></a> </td>
   <td width="192" align="center"> </td>
   <td width="192" align="center" >
   <a href="Sel_Turma.php" title="Voltar e selecionar outra turma" target="_self" >
   <font color="#000080"><h3>SELECIONAR<BR>TURMA</h3></font></a></td>
   <td width="192" align="center"></td>
   <td width="192" align="center"></td>
   <td width="192" align="center" ></td>
...
<?php
   ...
   $sql="Select IDCURSO,
         ...
         Where IdCurso = $_SESSION[idCurso]
         and IdTurma = $_SESSION[idTurma]";
   echo "<table width='770'> <tr> <td>Exercício</td> <td> Nome do Aluno Avaliado</td> <td> Data Avalição </td>  <td> Ficha Completa </td><td>Editar</td> <td> Excluir</td> </tr>";
