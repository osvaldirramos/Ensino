...
//          From pr_estagiario
 ...
 //  }
   echo "<input name='estagiario' value='S' type='checkbox'>Estagiário <br><br>";
...
<BR>
<BR>
   Exercício <input name="exercicio" type='text' size='20' value='' onkeyup="validaExercicio()"><BR>
<BR>
<BR>
Data da Avaliação <input name='data' value='' onfocus="displayCalendar(document.forms[0].data,'dd.mm.yyyy',this)" type='text' size='20' onkeyup="validaData()"><BR>
<BR>
Local da Avaliação <input name='local' type='text' size='20' value='ICEA'><BR>
<BR>
<input type="submit" value="Enviar" class="bt button" onclick="return validaForm()" >
</div>
</div>
</form>
</body>
