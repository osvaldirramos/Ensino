...
//    $conexao = ibase_connect("172.16.0.109:C:/DataBase_ICEA/Ensino/ENSINO.gdb","SYSDBA","u2u6#icea");
	...
	if($con= ibase_query($sql))
    {
   	    ...
   	    if(!strcmp($senha, $dados["SENHA"]))
        {
		   ...
		   if($f_busca_agte=ibase_fetch_assoc($r_busca_agte))
           {
               ...
               {
 		           echo "<script language='javascript' type='text/javascript'> alert('O SEU ACESSO AO SISTEMA NÃO ESTA LIBERADO'); window.location='index.php';</script>";
 		  	   }
		       else
               {
