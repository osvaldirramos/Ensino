...
<!--
<input type="button" value="ENVIAR" class="bt button" onClick="verificando();">
<div id="bt_sup"><input type="button" value="ENVIAR" class=" bt button" onclick="if(valida($('#form2'))) $('#form2').submit();" ></div>
-->
<div id="bt_sup" style="position:absolute; top: 70px !important; margin-left: 390px !important;"><input type="button" value="ENVIAR" class=" bt button" onclick="if(verificando()) $('#form2').submit();" ></div>

<form id="form2" name="form1" method="POST" action="montarFicha.php">
...
<table border="0" width="100%" >
  <tr>
   ...
   <td width="192" align="center">
        <a href="Sel_Avaliacao.php" title="Cancela a Inserção da Nova Ficha de Avaliação" target="_self" class="button2" >Voltar</a></td>
  </tr>
 </table>
<br>
<div id="conteudo">
...
$(document).ready(function(){
	$('#tab_aval tbody tr:odd').css('background-color','rgb(192, 192, 255)');
	$('#tab_aval tbody tr:odd td').css('border','1px solid #fff !important');
