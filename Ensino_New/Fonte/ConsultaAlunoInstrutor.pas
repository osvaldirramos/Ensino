...
begin
   ...
   if IBQuery_Instrutor.RecordCount = 0 then
      TabSheet_ComoCoordenadorInstrutor.Caption:= 'Instrutor - Nenhuma'
   else
      TabSheet_ComoCoordenadorInstrutor.Caption:= 'Instrutor - '+FormatFloat('0000', IBQuery_Instrutor.RecordCount);
end;
...
begin
   ...
   if Trim(JvEdit_CPF.Text) <> '' then
      VS_ComandoPessoa:= VS_ComandoPessoa+' and CPF_CIC Like '+#39+'%'+JvEdit_CPF.Text+'%'+#39;
