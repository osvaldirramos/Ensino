...
type
  TForm_Cad_ItemProva = class(TForm)
    ...
    procedure IBTable_Item_Prova_tmpPostError(DataSet: TDataSet; E: EDatabaseError; var Action: TDataAction);
    procedure IBTable_Item_Desc_tmpPostError(DataSet: TDataSet; E: EDatabaseError; var Action: TDataAction);
    procedure Table_Item_CPostError(DataSet: TDataSet; E: EDatabaseError; var Action: TDataAction);
...
procedure TForm_Cad_ItemProva.JvTransparentButton_GravaClick(Sender: TObject);
var
   VS_Comando: String;
begin
...
procedure TForm_Cad_ItemProva.JvTransparentButton_ConfigurarImpressoraClick(Sender: TObject);
begin
   if ((Form_Sel_ItemProva.IBTable_Item_Desc.State = DSInsert) or (Form_Sel_ItemProva.IBTable_Item_Desc.State = DSEdit )) then
...
procedure TForm_Cad_ItemProva.ToolButton3Click(Sender: TObject);
begin
  JvDBRichEdit_Text.SelectAll;
