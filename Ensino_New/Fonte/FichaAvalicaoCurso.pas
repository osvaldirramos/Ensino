   ...
   begin
      ...
      begin
         ...
         begin
            ...
            Funcoes.ExecutaQuery( DM.IBQuery_FA_Comentario, 'select c.IdFicha, c.Disciplina, m.NomeMateria, c.comentario '+
                                                     ' From fa_comentariotopico c, MateriaCurso M '+
                                                     ' Where c.disciplina = m.codmateria '+
                                                     ' and   c.IdCurso = m.IdCurso'+
                                                     ' and   c.IdTurma = m.IdTurma'+
                                                     ' and   c.comentario <> '+#39+'NIL'+#39+
                                                     ' and   c.IdCurso= '+ClientDataSet_FA_Avaliacao.FieldByName('IdCurso').AsString+
                                                     ' and   c.IdTurma = '+ClientDataSet_FA_Avaliacao.FieldByName('IdTurma').AsString+
                                                     ' and   c.idtopico = '+IBQuery_Topicos.FieldByName('IdTopico').AsString
                                );
            ...
            if CheckBox_Valores.Checked = True then
            begin
               While not DM.IBQuery_FA_Comentario.Eof do
               begin
                  if VS_Cor = '' then
                  begin
                     HTML.Add('<br><table border='+#39+'0'+#39+' cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' width='+#39+'770'+#39+' bgcolor='+#39+'#cccccc'+#39+' bordercolor='+#39+'#FFFFFF'+#39+' > '+
                              ' <tr><td><b style='+#39+'font-size:12px'+#39+' >COMENTÁRIOS DO TÓPICO: '+Funcoes.AjustarMaiscula(IBQuery_Topicos.FieldByName('Descricao').AsString)+'</b></td></tr></table>'+' <br/> ');
                  end;

                  VS_Cor:= 'White';

                  HTML.Add('<table width='+#39+'770'+#39+' bgcolor='+#39+VS_Cor+#39+'> '+
                           '      <tr > '+trim(DM.IBQuery_FA_Comentario.FieldByName('Disciplina').AsString)+' - '+trim(DM.IBQuery_FA_Comentario.FieldByName('NomeMateria').AsString)+'<br><br> '+
                           '       <td class='+#39+'style3'+#39+'>&nbsp;'+DM.IBQuery_FA_Comentario.FieldByName('Comentario').AsString+' <br/> '+
                           '      </tr> '+
                           '   </table>');
                  ProgressBar_MontaFicha.StepBy(1);
            ...
            begin
               ...
               begin
                  HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                           '   <tr> '+
                           '      <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp;Comentário Coordenador: <br/><br/>  '+
                           '                                            Instrutor - '+trim(DM.IBQuery_Executa.FieldByName('PostoGraduacao').AsString)+' - '+trim(DM.IBQuery_Executa.FieldByName('NomeGuerra').AsString)+' <br><br> '+
               ...
               begin
                  HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                           '  <tr> '+
                           '    <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp;Comentário Coordenador: <br/><br/> '+
                           '                                            Instrutor - '+trim(DM.IBQuery_Executa.FieldByName('PostoGraduacao').AsString)+' - '+trim(DM.IBQuery_Executa.FieldByName('NomeGuerra').AsString)+' <br> '+
                           '                                           '+trim(IBQuery_Critica.FieldByName('Comentario').AsString)+'<br/> '+
                           '  </tr> '+
                           ' </table>');
               end;
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                     '  <tr> '+
                     ' <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp; Comentário Instrutor: <br/><br/> '+VS_Disciplina+' '+VS_Docente+' <br/> '+
                     '                                    '+VS_Retorno+' <br/> '+
                     ' </tr> '+
                     ' </table> ');
         end;
   ...
   begin
      ...
      begin
         ...
         begin
            HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                     ' <tr> '+
                     '          <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp;'+'Comentário Instrutor: <br><br/> '+
                                                                      trim(IBQuery_Critica.FieldByName('Disciplina').AsString)+' - '+trim(IBQuery_Critica.FieldByName('DESCDISCIPLINA').AsString)+' <br><br> '+
                     '                                                '+trim(IBQuery_Critica.FieldByName('Comentario').AsString)+'<br/> '+
                     ' </tr> '+
                     ' </table>');
      ...
      begin
         ...
         begin
            ...
            begin
               ...
               VS_Docente:= '- Instrutor: '+trim(DM.IBQuery_Executa.FieldByName('PostoGraduacao').AsString)+' - '+trim(DM.IBQuery_Executa.FieldByName('NomeGuerra').AsString)+'<br>';
            end;

            VS_Retorno:= trim(IBQuery_Critica.FieldByName('Comentario').AsString);

            if ((VS_Disciplina = '' ) and (VS_Docente = '')) then
            begin
               HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                        '  <tr> '+
                        ' <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp; Comentário Aluno:  <br/><br/>'+
                        '                                    '+VS_Retorno+' <br/> '+
                        ' </tr> '+
                        ' </table> ');
            end
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            begin
               ImprimirMsg(HTML, 'Comentário Aluno: '+' <br/><br/> ' +
                                 IBQuery_Complemento01.FieldByName('Disciplina').AsString+' - ' +IBQuery_Complemento01.FieldByName('DescDisciplina').AsString+' <br/> ' +
      ...
      begin
         ...
         begin
            ...
            begin
               HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'>'+
                        '  <tr> '+
                        '    <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp;'+
                                                                     'Comentário Aluno: '+' <br/><br/> ' +
                                                                     IBQuery_Complemento02.FieldByName('Disciplina').AsString+' - ' +IBQuery_Complemento02.FieldByName('DescDisciplina').AsString+' <br/> ' +
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            HTML.Add('<table cellspacing='+#39+'0'+#39+' cellpadding='+#39+'0'+#39+' border '+#39+'1'+#39+' width='+#39+'770'+#39+'> '+
                     '  <tr> '+
                     ' <td width = '+#39+'810'+#39+' class = '+#39+'style3'+#39+'>&nbsp;Comentário Coordenador: '+VS_Coordenador+' <br/><br/> '+
