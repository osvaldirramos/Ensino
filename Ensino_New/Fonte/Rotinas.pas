...
//   Ultima_Atualizacao= '27-Abril-2021';
//   Versao= '06.60';

//   Ultima_Atualizacao= '13/01/2022';
//   Versao= '06.61';
   Ultima_Atualizacao= '26/06/2020';
   Versao= '06.58';
   Atualizacao = 'A1004';
...
//   Cor_Tela= clMenuBar;
   ...
   Funcao = Class
      ...
      Public
         Function DataAtualServidor: String;

         Function TrocarAcentoPor_(VS_String: String) : String;

         Procedure ListaLocalidade(ComboBox_Localidade: TComboBox);
         ...
         Function VerificaSerie(VS_IdCurso, VS_IdTurma, VS_CodMateria, VS_Disc, VS_Unid, VS_SubUni, VS_Objetivo : string): String;
//         Function VerificaSerie(VS_IdCurso, VS_IdTurma, VS_CodMateria, VS_Objetivo : string): String;
         ...
         procedure CadastrarAcessoFichaAvaliacao(P_IdCurso, P_IdTurma, P_Identidade, P_Nome, P_senha: String);
...
begin
   ...
   begin
      ...
      begin
         ...
         if  DM.Query_Usuario.FieldByName('Nome').AsString = '' then
...
begin
   ...
   AModulo[5]:= 'Instrutor - Consulta Instrutor por Matéria';
   AModulo[6]:= 'Instrutor - Quantidade de Instrutores por Curso';

   AModulo[7]:= 'Tabelas Auxiliares - Posto/Graduação';
   AModulo[8]:= 'Tabelas Auxiliares - Quadro/Especialidade';
   AModulo[9]:= 'Tabelas Auxiliares - Resp. pela assinatura dos relatórios';
   AModulo[10]:= 'Tabelas Auxiliares - Unidades';
   AModulo[11]:= 'Tabelas Auxiliares - Paises';
   AModulo[12]:= 'Tabelas Auxiliares - Desligamento';

   AModulo[13]:= 'Consultas - Consulta de Alunos e Instrutores';
   AModulo[14]:= 'Consultas - Consulta Cursos Finalizados';
   AModulo[15]:= 'Consultas - Relatório INFRAERO';
   AModulo[16]:= 'Consultas - Historico (ASEA/APAC)';
   AModulo[17]:= 'Consultas - Estatistica Diárias';

   AModulo[18]:= 'Ferramentas - Editor de Texto';
   AModulo[19]:= 'Ferramentas - Avaliação';
   AModulo[20]:= 'Ferramentas - PTS - Base';
   AModulo[21]:= 'Ferramentas - Configuração do Sistema';
   AModulo[22]:= 'Ferramentas - Carga PAELS';

   AModulo[23]:= 'Fichas Avaliação - Indicadores de Qualidade EAVC';
   AModulo[24]:= 'Fichas Avaliação - Consulta das Fichas que estão para ser Avaliada';
   AModulo[25]:= 'Fichas Avaliação - Resultados Avaliação';
   AModulo[26]:= 'Fichas Avaliação - Cadastro Avaliadores de Curso';
   AModulo[27]:= 'Fichas Avaliação - Cadastro das Fichas de Avaliação';
   AModulo[28]:= 'Fichas Avaliação - Cadastro das Fichas de Avaliação Coordenador';

   AModulo[29]:= 'Menu Principal - Cadastro Curso';
   AModulo[30]:= 'Menu Principal - Corpo Docente';
   AModulo[31]:= 'Menu Principal - Cadastro Turma/Aluno/Instrutor';
   AModulo[32]:= 'Menu Principal - Cadastro Disciplina';
   AModulo[33]:= 'Menu Principal - Quadro Global de Avaliação';
   AModulo[34]:= 'Menu Principal - Cadastro Item Prova';
   AModulo[35]:= 'Menu Principal - Montar Prova';
   AModulo[36]:= 'Menu Principal - Correção da Prova';
   AModulo[37]:= 'Menu Principal - PTS';
   AModulo[38]:= 'Menu Principal - Habilitar Ficha de Avaliação';
   AModulo[39]:= 'Menu Principal - Consulta de Cursos Executados';
   AModulo[40]:= 'Menu Principal - Grau Final da Turma';
   AModulo[41]:= 'Menu Principal - Consulta de Alunos e Instrutores';
   AModulo[42]:= 'Menu Principal - Critica Espontanea';
   AModulo[43]:= 'Menu Principal - Aluno com Notas Abaixo da Média';
   AModulo[44]:= 'Menu Principal - Providência';
   AModulo[45]:= 'Menu Principal - Consulta Avaliação Pós Curso';

   AModulo[46]:= 'Extras - Relação de Cursos Planejados';
   AModulo[47]:= 'Extras - Relação de Cursos Andamento';
   AModulo[48]:= 'Extras - Relação de Cursos Executados';
   AModulo[49]:= 'Extras - Consulta de Ficha de Avaliação de Curso';
   AModulo[50]:= 'Extras - Acompanhamento das Providências';
   AModulo[51]:= 'Extras - Acompanhamento da Avaliação Pós Curso';
end;
...
// Descricao    : Criação dos usuários da nova ficha de avaliaÇão de Curso
//------------------------------------------------------------------------------

procedure Funcao.CadastrarAcessoFichaAvaliacao(P_IdCurso, P_IdTurma, P_Identidade, P_Nome,  P_senha: String);
var
   VS_Comando: String;
begin
   p_senha:= FormatFloat('000',StrToInt(P_Senha));

   VS_Comando:= 'Select count(1) As Qtd from FAC_UsuarioTurma '+
   ...
   begin
      Funcoes.ExecusaoQuery('Insert into FAC_USUARIOTURMA (IdCurso, IdTurma, Identidade, nome, senha)'+
                            ' values ( '+P_IdCurso+', '+P_IdTurma+', '+#39+P_Identidade+#39+', '+#39+P_Nome+#39+', '+#39+P_senha+#39+')'
                           );
   end
   else
   begin
      Funcoes.ExecusaoQuery('update FAC_USUARIOTURMA set nome = '+#39+P_Nome+#39+' , ' +
                            '                            senha = '+#39+P_senha+#39+
                            ' where IdCurso = '+P_IdCurso+
                            ' and IdTurma = '+P_IdTurma+
                            ' and Identidade =  '#39+P_Identidade+#39
...
///----- Tratamento para DA_CURSO - Apagar_FA
...
begin
   try
      ...
      DM.IBTransaction_Ensino.Rollback;
      showmessage('Erro ao gravar os dados - Falta de Conexão!');
   end;
end;
...
Function Funcao.VerificaSerie(VS_IdCurso, VS_IdTurma, VS_CodMateria, VS_Disc, VS_Unid, VS_SubUni, VS_Objetivo : string): String;
var
   Retorno: String;
begin
...
//------------------------------------------------------------------------------
// Descricao: Tratamento dos JvExpressButton quando a sua apresentacao
// Data     : 07/12/16
//
// Atualizado em:
// Descricao    :
...
//------------------------------------------------------------------------------
// Descricao: Procedure CriarDiretorio
// Data     :
//
// Atualizado em:
// Descricao    :
...
procedure Funcao.CriarDiretorio(VS_Diretorio: String);
begin
...
//------------------------------------------------------------------------------
// Descricao: Verifica a versão do programa
// Data     :
//
// Atualizado em: 01/09/2021
// Descricao    : Verifica a versaão do programa e solicita a atualização quando
//                a versão não for compativel com a ultima versão
//------------------------------------------------------------------------------

Procedure Funcao.VerificarVersao;
begin
   if (DM.IBTable_Configuracao.FieldByName('SIGLA').AsString = 'ICEA') then
   begin
      Funcoes.OpenQuery( 'Select Atualizacao, Data_Atualizacao From VERSAO_SGQ ' );

      if DM.IBQuery_Executa.FieldByName('Atualizacao').AsString <>  Atualizacao then
         ShowMessage( #13+'Versão Atual: '+DM.IBQuery_Executa.FieldByName('Atualizacao').AsString+' de '+copy(DM.IBQuery_Executa.FieldByName('Data_Atualizacao').AsString,1,10)+#13+#13+
                       'A versão utilizada não é a última versão, '+#13+#13+
                       'Para atualizar o SGEW é preciso seguir os seguintes passos: '+#13+
                       ' - Fechar o SGEW, '+#13+
                       ' - Acessar a pasta "DE\SGEW" na rede '+#13+
                       ' - Copiar o arquivo Execucao.exe para pasta "C:\DataBase_ICEA\Ensino"');
   end;
end;
...
// Descricao    : Tratamento para montar um senha
//------------------------------------------------------------------------------

Function Funcao.GetRandomPassword(Size: Integer; Tipo : Integer = 1): String;
var
  I: Integer;
  Chave: String;
const
...
//------------------------------------------------------------------------------
// Descricao    : Troca os acentos por _
//
// Atualizado em: 27/04/2022
//------------------------------------------------------------------------------

Function Funcao.DataAtualServidor: String;
var
   VS_Retorno: String;
begin
   Funcoes.ExecutaQuery(DM.IBQuery_Executa, 'select current_timestamp as data from rdb$database' );

   VS_Retorno:= DM.IBQuery_Executa.FieldByName('data').AsString;
   DataAtualServidor:= VS_Retorno;
end;
...
Function Funcao.TrocarAcentoPor_(VS_String: String) : String;
var
   VS_Retorno: String;
begin
   VS_Retorno:= VS_String;

   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ç', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'á', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'é', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'í', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ó', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ú', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ã', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'õ', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'à', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ò', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'â', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ê', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'î', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'ô', '_');
   VS_Retorno:= Funcoes.DePara(VS_Retorno, 'û', '_');
   ...
   TrocarAcentoPor_:=VS_Retorno;
end;

//------------------------------------------------------------------------------
// Descricao    : Preencher o combobox com as localidades
//
// Atualizado em: 17/05/2022
//------------------------------------------------------------------------------


Procedure Funcao.ListaLocalidade(ComboBox_Localidade: TComboBox);
begin
   Funcoes.OpenQuery('select distinct Localidade From PTS_Localidade Order By Localidade');

   DM.IBQuery_Executa.First;
   ComboBox_Localidade.Items.Clear;
   ComboBox_Localidade.Text:= '';
   ComboBox_Localidade.Items.Add('');

   While not DM.IBQuery_Executa.Eof do
   begin
      ComboBox_Localidade.Items.Add(Trim(DM.IBQuery_Executa.FieldByName('Localidade').AsString));
