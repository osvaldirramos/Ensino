...
//   Form_Sel_Curso.IBTable_Curso.FieldByName( 'CURSOEAD').AsString:= 'N';
...
begin
   if (DM.Query_Usuario.FieldByName('Secao').AsString = 'COPM') Then
      ...
      if (DM.Query_Usuario.FieldByName('Secao').AsString = 'EAD') Then
         Funcoes_SUE.AlimentaComboBox(Form_MenuPrincipal.ComboBox_Curso, 'CodCurso', 'Curso', ' CURSO_EAD = '+#39+'S'+#39, 'CodCurso')
      else
