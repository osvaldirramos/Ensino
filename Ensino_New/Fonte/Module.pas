...
type
  TDM = class(TDataModule)
    ...
    IBDatabase_Local: TIBDatabase;
    IBTransaction_Local: TIBTransaction;
    IBQuery_Local: TIBQuery;
    IBQuery_ItemLocal: TIBQuery;
    IBTable_Relatorio_FAC: TIBTable;
    IBTable_Versao_SGQ: TIBTable;
    DST_VersaoSGQ: TDataSource;
    IBTable_Versao_SGQVERSAO: TIBStringField;
    IBTable_Versao_SGQDATA: TDateTimeField;
    IBTable_Relatorio_FACIDCURSO: TSmallintField;
    IBTable_Relatorio_FACIDTURMA: TIntegerField;
    IBTable_Relatorio_FACIDFICHA: TIntegerField;
    IBTable_Relatorio_FACIDTOPICO: TIntegerField;
    IBTable_Relatorio_FACTOPICO: TIBStringField;
    IBTable_Relatorio_FACNOBSERVADO: TIBStringField;
    IBTable_Relatorio_FACABAIXO: TIBStringField;
    IBTable_Relatorio_FACATINGIU: TIBStringField;
    IBTable_Relatorio_FACACIMA: TIBStringField;
    IBTable_Relatorio_FACMEDIA: TIBStringField;
    IBTable_Relatorio_FACCOMENTARIO: TIBStringField;
    IBTable_Relatorio_FACDESTAQUE: TIBStringField;
    IBTable_TurmaINDICACAO_INSTRUTOR: TIBStringField;
    IBQuery_FA_Comentario: TIBQuery;
