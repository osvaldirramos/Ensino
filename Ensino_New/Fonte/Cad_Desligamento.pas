...
{
a - conclusão de curso de acordo com a MCA 37-87 item 9.3 letra a - a - 1 - Atende a MCA anterior
b - insuficiência de nota de acordo com a MCA 37-87 item 9.3 letra b - b - 1 - Atende a MCA anterior
c - insuficiência de frequência de acordo com a MCA 37-87  item letra c - c - 1 - Atende a MCA anterior
d - solicitação do aluno ao ser deferido o seu requerimento pelo Comandante da OM responsável pela execução do curso de acordo com a MCA 37-87  item 9.3 letra d - d - 1 - Atende a MCA anterior
e - indiciplina de acordo com a MCA 37-87  item 9.3 letra e - e - 1 - Atende a MCA anterior
f - interesse da administração de acordo com a MCA 37-87  item 9.3 letra "f", f - 1 - Atende a MCA anterior
g - óbito de acordo com a MCA 37-87 item 9.3 letra g - g - 1 - Atende a MCA anterior

----- Atende a MCA-37-87 de 2018

h - Insuficiência de aproveitamento - a - 2 - Atende a MCA 37-87 de 2018
i - Insuficiência de participação, de acordo com a Ementa de cada curso EAD - b - 2 - Atende a MCA 37-87 de 2018
j - Insuficiência de frequência, conforme estabelecido neste manual - c - 2 - Atende a MCA 37-87 de 2018
k - Falta de acesso ao AVA do curso durante a primeira semana de sua realização - d - 2 - Atende a MCA 37-87 de 2018
l - Solicitação do aluno, ao ser deferido o seu requerimento pelo Comandante, Chefe ou Diretor da OM responsável pela execução do curso (anexo E) - e - 2 - Atende a MCA 37-87 de 2018
m - Indisciplina; e - f - 2 - Atende a MCA 37-87 de 2018
n - interesse da administração - g - 2 - Atende a MCA 37-87 de 2018
...
type
  TForm_Tab_Desligamento = class(TForm)
    ...
    Table_CadastroMOTIVODESLIG: TIBStringField;
    Table_CadastroDESCRICAO: TIBStringField;
    Table_CadastroALINEA: TIBStringField;
    Table_CadastroVERSAO: TIBStringField;
    Query_ConsultaMOTIVODESLIG: TIBStringField;
    Query_ConsultaDESCRICAO: TIBStringField;
    Query_ConsultaALINEA: TIBStringField;
    Query_ConsultaVERSAO: TIBStringField;
...
begin
   VS_Comando:= 'Select MotivoDeslig, Descricao, Alinea, Versao From Desligamento where versao = 2 or MotivoDeslig = '+#39+'a'+#39;
   if trim(Edit_Motivo.Text) <> '' then
      VS_Comando:= VS_Comando+' Where Upper(Alinea) Like '+#39+trim(UpperCase(Edit_Motivo.Text))+'%'+#39;
