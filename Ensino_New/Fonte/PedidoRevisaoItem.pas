...
type
  TForm_PedidoRevisaoItem = class(TForm)
    ...
    JvShape4: TJvShape;
    JvTransparentButton_ExcluirSolicitacao: TJvTransparentButton;
    DST_ItemTest: TDataSource;
    Panel13: TPanel;
    Label17: TLabel;
    DBText4: TDBText;
    Label18: TLabel;
    ...
    procedure JvTransparentButton_ExcluirSolicitacaoClick(Sender: TObject);
...
begin
  HouveMudanca:= False;
   ...
   Query_ChefeAVL.Open;
   Query_ChefeAVL.Locate('SIGLA','EEAE',[]);
...
procedure TForm_PedidoRevisaoItem.JvTransparentButton_ExcluirSolicitacaoClick( Sender: TObject);
var
   VI_Retorno: integer;
begin
   VI_Retorno:= Application.MessageBox('Essa exclusão eliminará o pedido de revisão selecionada '+#13+#13+'Confirma a exclusão do registro ?', 'Atenção', MB_YesNo+mb_DefButton2+mb_IconQuestion);
