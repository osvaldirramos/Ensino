...
type
  TForm_Rel_GPA_CIAAN = class(TForm)
    QuickRep1: TQuickRep;
    QRBand2: TQRBand;
...
var
  Form_Rel_GPA_CIAAN: TForm_Rel_GPA_CIAAN;
...
procedure TForm_Rel_GPA_CIAAN.QuickRep1BeforePrint(Sender: TCustomQuickRep; var PrintReport: Boolean);
var
   VS_Comando: String;
...
procedure TForm_Rel_GPA_CIAAN.FormClose(Sender: TObject; var Action: TCloseAction);
begin
