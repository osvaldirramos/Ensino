...
type
  ...
  private    { Private declarations }
     ...
     MResposta: array[1..200, 1..7] of String;
     ...
     MCorrecao: array[1..200, 1..200] of char;    //--- 0 Errou, 1 Acertou
     MNotaAluno: array[1..200] of real;
     MNumItem: array[1..200] of integer;
     MIrregularidade: array[1..200] of integer;
     MAnulada: array[1..200] of integer;

     MAcertos: array[1..200] of integer;
     MErros: array[1..200] of integer;
     MBrancos: array[1..200] of integer;

     MAcertosAA: array[1..200] of Integer;
     MNalunosAA: array[1..200] of Integer;
     MBrancosAA: array[1..200] of Integer;

     MAcertosAB: array[1..200] of Integer;
     MNalunosAB: array[1..200] of Integer;
     MBrancosAB: array[1..200] of Integer;

     MAcertosAM: array[1..200] of Integer;
     MNalunosAM: array[1..200] of Integer;
     MBrancosAM: array[1..200] of Integer;

     MIF: array[1..200] of Real;
     MID: array[1..200] of Real;
     MIO: array[1..200] of Real;
