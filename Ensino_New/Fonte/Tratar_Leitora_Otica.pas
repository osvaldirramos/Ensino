   ...
   begin
      ...
      begin
        ...
        begin
           ...
           VS_RESP:= Copy(VS_Tudo,51,VI_TotItensTeste);  // respostas do aluno lido max 100
        end
        else
        begin
        ...
        begin
           VS_Comando:= 'Select Identidade from alunoturma '+
                        ' where IdCurso = '+IntToStr(VI_IdCurso)+
                        ' and IdTurma = '+IntToStr(VI_IdTurma)+
                        ' and Codigoaluno = '+VS_Cod;
