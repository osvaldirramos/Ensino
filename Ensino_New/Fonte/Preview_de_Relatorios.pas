...
//   Form_Cad_ItemProva.JvDBRichEdit_Text.SelectAll ;
   ...
   Funcoes.ExecutaQuery( IBQuery_Documento, 'select doc, Descricao from Documento where Codigo = 12');
      Documento.SelectAll;
   ...
   Form_PreviewRel.Trocar('#CodCurso', Frame_SelCurso.ComboBox_Curso.Text+' - '+Frame_SelCurso.VS_DescCurso);
