...
var
  Form_CargaTurmas: TForm_CargaTurmas;
...
procedure TForm_CargaTurmas.FormActivate(Sender: TObject);
begin
...
procedure TForm_CargaTurmas.JvTransparentButton_ImprimirClick(Sender: TObject);
begin
...
procedure TForm_CargaTurmas.JvTransparentButton_CargaClick(Sender: TObject);
begin
   Carga_ICEA
end;
...
procedure TForm_CargaTurmas.Carga_ICEA;
var
   ...
   begin
      ...
      begin
         ...
         begin
            ...
            if ((uppercase(VS_String) = 'PAPEL') and (Copy(linha, 6, 1) = ',')) then
            begin
               VS_Status:= 'Erro_Virgula';
               ShowMessage('O Separador deve ser ponto e virgula e não '+Copy(linha, 6, 1)+'...');
               Break;
            end;
         end
         else
         begin
            ...
            case VI_Cont of
               ...
               6:VS_Nome:= UTF8Decode(VS_String);
               7:VS_Guerra:= UTF8Decode(VS_String);
               8:VS_Unidade:= UTF8Decode(VS_String);
               9:VS_Email:= UTF8Decode(VS_String);
               10:VS_Celular:= VS_String;
               11:VS_RG:= VS_String;
               12:VS_CPF:= VS_String;
               13:VS_Saram:= VS_String;
               14:VS_Matricula:= VS_String;
            end;
            VS_String:= '';
         end;
      end;
...
//               break;
         ...
         begin
            if (( VS_Status = 'Erro') and (VS_Papel = 'papel') and (VS_Curso = 'curso') and
                (VS_Posto = 'posto') and (VS_quadro = 'quadro') and (VS_Esp = 'esp') and
                (VS_Nome = 'nome') and (VS_Guerra = 'guerra') and (VS_Unidade = 'unidade') and
                (VS_Email = 'e-mail') and (VS_Celular = 'telefone') and (VS_RG = 'rg') and
                (VS_CPF = 'cpf') and (VS_SARAM = 'saram') and (VS_Matricula = 'status')) then
            begin
               VS_Status:= 'Continuar';
            end
            else
   ...
   //               Break;
               ...
               begin
                  ...
                  begin
                     if (( VS_Status = 'Erro') and ( VS_CPF = '')) then
                     begin
...
procedure TForm_CargaTurmas.Tratar_Variaveis_ICEA;
begin
...
procedure TForm_CargaTurmas.Tratar_Aluno_ICEA(VI_ContReg: Integer);
var
...
procedure TForm_CargaTurmas.Tratar_Instrutor_ICEA(VI_ContReg: Integer);
var
...
begin
   ...
   begin
      ...
      If trim(IBQuery_InstrutorTurma.FieldByName('Identidade').AsString) = '' then
      begin
...
procedure TForm_CargaTurmas.Celular(VS_Identidade, Celular: String);
begin
   //--- Tratamento do Cadastro do Telefone
...
procedure TForm_CargaTurmas.FinalizaCarga;
begin
//   CloseFile ( arq );
...
procedure TForm_CargaTurmas.GerarCodigoAluno(VS_IdCurso: String; S_IdTurma: String);
var
...
procedure TForm_CargaTurmas.JvTransparentButton_RetornarClick(Sender: TObject);
begin
   Close;
end;
...
procedure TForm_CargaTurmas.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TForm_CargaTurmas.JvTransparentButton_WindowsClick(Sender: TObject);
begin
    Funcoes.Windows;
end;
...
Function TForm_CargaTurmas.TratarPostoGraduacao(VS_usuario_posto: String): String;
var
   VS_Posto: String;
begin
