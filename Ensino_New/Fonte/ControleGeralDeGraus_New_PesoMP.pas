...
unit ControleGeralDeGraus_New_PesoMP;
...
type
  TForm_MontaControleGeraoGraus_PesoMP = class(TForm)
...
var
  Form_MontaControleGeraoGraus_PesoMP: TForm_MontaControleGeraoGraus_PesoMP;
...
procedure TForm_MontaControleGeraoGraus_PesoMP.FormActivate(Sender: TObject);
var
...
begin
   ...
   Funcoes.CabecalhoForm(Form_MontaControleGeraoGraus_PesoMP, ' Controle Geral de Graus - Pes MP');
...
procedure TForm_MontaControleGeraoGraus_PesoMP.ZeraMediaMP;
var
   i: integer;
begin
   for i:= 1 to 25 do
...
procedure TForm_MontaControleGeraoGraus_PesoMP.CalculaMediaFase;
var
   i: integer;
begin
...
Procedure TForm_MontaControleGeraoGraus_PesoMP.CalculaMediaParcial;
begin
   if VI_MP <> Form_Cad_CorrecaoProva.IBQuery_ResultadoExame.FieldByName( 'MediaParcial').AsInteger then
   begin
      if VI_PesoMP = 0 then
...
procedure TForm_MontaControleGeraoGraus_PesoMP.VerificaLinha;
begin
...
procedure TForm_MontaControleGeraoGraus_PesoMP.ImprimirResultado;
begin
   SetarDefault(8);
   Text1.Lines.Add(VS_Msg0);
   SetarDefault(8);
...
procedure TForm_MontaControleGeraoGraus_PesoMP.SetarDefault(VI_Size: Integer);
begin
...
procedure TForm_MontaControleGeraoGraus_PesoMP.TracarLinha;
begin
   SetarDefault(9);
...
procedure TForm_MontaControleGeraoGraus_PesoMP.JvTransparentButton_RetornarClick(Sender: TObject);
begin
   Close;
end;
...
procedure TForm_MontaControleGeraoGraus_PesoMP.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure TForm_MontaControleGeraoGraus_PesoMP.JvTransparentButton_WindowsClick(Sender: TObject);
begin
   Funcoes.Windows;
end;
...
procedure TForm_MontaControleGeraoGraus_PesoMP.JvTransparentButton_ImprimirClick( Sender: TObject);
var
   N: Integer;
begin
...
Procedure TForm_MontaControleGeraoGraus_PesoMP.Trata_Msg( Tam: Integer; PS_Msg1, PS_Msg2, PS_Msg3: String);
begin
...
procedure TForm_MontaControleGeraoGraus_PesoMP.JvTransparentButton_ConfigImpressoraClick(Sender: TObject);
begin
...
procedure TForm_MontaControleGeraoGraus_PesoMP.Trocar(Trocar: String; Por: String);
var
   Posicao: Integer;
begin
