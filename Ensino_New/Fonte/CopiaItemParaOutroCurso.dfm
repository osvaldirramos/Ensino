object Form_CopiaItemParaOutroCurso: TForm_CopiaItemParaOutroCurso
  Left = 491
  Top = 30
  Width = 800
  Height = 978
  Caption = 'Ensino -->Copia de Item para Outro Curso'
  Color = 16577515
  ...
  object Panel_Botoes: TPanel
    ...
    object JvTransparentButton_Copiar: TJvTransparentButton
      ...
      Width = 64
      Height = 51
      Hint = 'Copia os itens selecionados para disciplina selecionado abaixo.'
      BorderWidth = 0
      Caption = 'Copiar '
      Font.Charset = ANSI_CHARSET
      Font.Color = clWindowText
  ...
  object Query_MontaCurso: TIBQuery
    ...
    CachedUpdates = True
    SQL.Strings = (
      'Select c.IdCurso, t.IdTurma, c.CodCurso, c.NomeCurso'
    ...
    object Query_MontaCursoIDTURMA: TIntegerField
      FieldName = 'IDTURMA'
