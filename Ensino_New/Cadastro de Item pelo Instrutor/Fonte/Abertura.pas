...
begin
   ...
   begin
      ShowMessage(#13+'Verifique junto a seção de avaliação se os itens da prova estão disponíveis para serem revisados'+#13+'e se foi montado a abrangencia da prova...');
   ...
   begin
      ...
      begin
         ShowMessage('Prova não disponível...');
         MaskEdit_Nome.SetFocus;
      end;
   end;
end;
